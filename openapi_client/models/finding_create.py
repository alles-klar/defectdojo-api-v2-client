...
class FindingCreate(object):
    ...
    def __init__(self, id=None, notes=None, test=None, thread_id=None, found_by=None, url=None, tags=None, title=None, date=None, cwe=None, cve=None, severity=None, description=None, mitigation=None, impact=None, steps_to_reproduce=None, severity_justification=None, references=None, is_template=None, active=None, verified=None, false_p=None, duplicate=None, out_of_scope=None, under_review=None, under_defect_review=None, is_mitigated=None, mitigated=None, numerical_severity=None, last_reviewed=None, line_number=None, sourcefilepath=None, sourcefile=None, param=None, payload=None, hash_code=None, line=None, file_path=None, static_finding=None, dynamic_finding=None, created=None, jira_creation=None, jira_change=None, scanner_confidence=None, duplicate_finding=None, review_requested_by=None, defect_review_requested_by=None, mitigated_by=None, reporter=None, last_reviewed_by=None, sonarqube_issue=None, endpoints=None, duplicate_list=None, reviewers=None):  # noqa: E501
    ...
    def duplicate_list(self):
        """Gets the duplicate_list of this FindingCreate.  # noqa: E501


        :return: The duplicate_list of this FindingCreate.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def duplicate_list(self, duplicate_list):
        """Sets the duplicate_list of this FindingCreate.


        :param duplicate_list: The duplicate_list of this FindingCreate.  # noqa: E501
        :type: list[int]
        """
